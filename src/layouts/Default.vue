  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header>
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <h1>
          <g-link class="hover:text-indigo-800" style="font-size: 1.8rem" :class="{ 'text-gray-400 hover:text-gray-500': theme !== 'theme-light'}" to="/">murerkinn</g-link>
        </h1>
    ...
    <footer class="bg-indigo-600 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:murerkinn@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/murerkinn" target="_blank" class="text-white hover:text-gray-400">
